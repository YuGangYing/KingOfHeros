...
////            anim["StandBy01"].wrapMode = WrapMode.Loop;
////            anim["StandBy01"].speed = 0;
////            anim["StandBy01"].normalizedTime = 1F;
//            
...
////                anim.Blend ("Run01",0,0.2F);
//                anim.CrossFade("StandBy01");
//            } else {
//                //Fade in walking animation
////                anim.Blend ("Run01",1,0.2F);
//                anim.CrossFade("Run01");
//                //Modify animation speed to match velocity
//                AnimationState state = anim["Run01"];
//                
