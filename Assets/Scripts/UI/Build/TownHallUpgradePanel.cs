...
namespace UI
{
    public class TownHallUpgradePanel : BuildUpgradePanelBase
    {
        public const PanelID id = PanelID.TownHallUpgradePanel;

        public override string GetResPath()
        {
            return "TownHallUpgrade.prefab";
        }
        ...
        protected override void Initimp(List<GameObject> prefabs)
        {
            ...
            goldLabel.text = DataManager.getLanguageMgr().getString(goldLabel.text);
