...
public class RPGCamera : MonoBehaviour
{
    ...
    public void Set(float yaw, float pitch, float dis)
    {
        distance = dis;
...
//         bool rotate = RPGInputUtils.GetButtonSafe(MouseRotateButton, false) && false;
//         bool mouseLook = RPGInputUtils.GetButtonSafe(MouseLookButton, false) && false;
